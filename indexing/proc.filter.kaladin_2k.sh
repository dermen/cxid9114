...
srun -n 40 -c 2  --pty libtbx.python process_filtered_mpi.py -o $AGGDIR --Z 8 --dilate 2 --sbpad 3 --thresh 1e-3 --ngpu 8 --filteredexpt $IDXDIR/filtered.expt --defaultF 1e3 
