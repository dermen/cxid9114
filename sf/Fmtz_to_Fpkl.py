...
parser.add_argument("--reference", type=str, default=None, help="|F| reference pickle")
parser.add_argument("--referenceForCCano", type=str, default=None, help="|F| reference pickle, for computing CCano (only heavy atoms should have anomalous scatering corrections in this reference)")
